...
INSERT INTO CONSULTANT(email, firstname, lastname, experience, manager_id, release_date) VALUES('robin.jesson@alten.com', 'Robin', 'Jesson', 7, 1, NOW()) ON CONFLICT DO NOTHING;
